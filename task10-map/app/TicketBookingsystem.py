import sys
sys.path.append('C:/Users/deebi/OneDrive/Desktop/TicketBookingSystem/task10-map/bean')
from Venue import Venue
sys.path.append('C:/Users/deebi/OneDrive/Desktop/TicketBookingSystem/task10-map/service')
    ...
    while True:
        ...
        try:
            if command == "create_event":
                ...
                #     print(f"Genre: {actress_name}")

                # elif event.event_type == "Sport":
                #     print(f"Sport Name: {event.sport_name}")
                #     print(f"ATeam's name: {event.teams_name}")
                ...
                # venue = Venue(venue_name, venue_address)
                # EventImpl.create_event(event_name, date, time, total_seats, ticket_price, event_type, venue)

                event_name = input("Enter event name: ")
                num_tickets = int(input("Enter number of tickets to book: "))
                array_of_customers = set()
